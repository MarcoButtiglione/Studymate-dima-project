...
void main() {
  ...
  testWidgets('Clicking category card one time - searchpage - smartphone',
      (tester) async {
    //setup
    app.main();
    //do
    ...
    await tester.tap(find.byKey(Key('categoryCard')).at(0));
    await tester.pumpAndSettle(const Duration(seconds: 2));
    //test
    expect(find.text('Aereospace'), findsNWidgets(2));
  });
  testWidgets('Clicking category card two times - searchpage - smartphone',
      (tester) async {
    //setup
    app.main();
    //do
